...
Read all documentation in the directory `.agent`
Read the project technical specificationRead `CREATE-MCP-SERVER-md`
Read how MCP primitives are implemented using a declarative, object-based JavaScript architecture `PRIMITIVAS-MCP.md`
...
- If you make assumptions, record them in the Issue/PR/ADR. Use directory `.agent`.
